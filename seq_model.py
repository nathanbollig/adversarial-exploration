...
def encode_raw_sequences(X_raw, aa_vocab):
    ...
    """
    # Encode each instance as a list of indices into aa vocabulary
    aa_dict = {}
...
def big_bang(num_instances=5000, p=0.5, seed0 = 0, seed1 = 1):
    ...
    """
    # Generate data
    X_raw, y, aa_vocab, m0, m1 = generate(num_instances=num_instances, p=p, seed0=seed0, seed1=seed1)
    ...
    return model, [X_train, X_val, X_test], [y_train, y_val, y_test], m0, m1
...
def main(name, num_instances=5000, p=0.5, seed0 = 0, seed1 = 1):
    ...
    model, X_list, y_list, m0, m1 = big_bang(num_instances=num_instances, p=p, seed0 = seed0, seed1 = seed1)
