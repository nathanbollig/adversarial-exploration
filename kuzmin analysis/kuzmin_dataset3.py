...
# =============================================================================
# Compute bat distribution
# =============================================================================

x = decode_from_one_hot(x_bat, n_positions=N_POS, n_characters=N_CHAR)

x_bat_dist = [[] for _ in range(N_POS)]
for i in range(N_POS):
    aa_index = x[i]
    if aa_index == -1:
        continue
...
# =============================================================================
# Visualization b: bat SARS CoV 2 vs. human (in training set)
# =============================================================================

cossim_vals = [cosine_similarity(pos_dist[i], x_bat_dist[i]) for i in range(N_POS)]
