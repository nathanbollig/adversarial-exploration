...
x_MM, data = greedy_flip(x_bat, 0, aa_vocab, model, generator=None, n_positions=N_POS, n_characters=N_CHAR, confidence_threshold = 0.9, weights = MatrixInfo.blosum62, gamma=0.1, cost=1000)
...
# =============================================================================
# Compute similarity of each sequence to MM set
# =============================================================================
